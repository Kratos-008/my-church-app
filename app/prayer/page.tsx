    ...
    <div className="flex flex-col items-center text-gray-500">
      ...
      <div className="text-center mt-16 bg-gradient-to-r from-green-500 to-blue-600 text-white py-10 px-4">
        ...
        <div className="flex justify-center flex-wrap gap-4">
          <Link href="/contact" className="bg-white text-black font-semibold px-5 py-2.5 rounded-md hover:bg-gray-100 transition">
            Contact a Pastor
          </Link>
          <Link href="/" className="bg-white text-black font-semibold px-5 py-2.5 rounded-md hover:bg-gray-100 transition">
            Back to Home
          </Link>
        </div>
      </div>
